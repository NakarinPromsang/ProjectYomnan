                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-flex">
                        <div class="flex-grow-1 bg-register-image"
                            style="background: url(&quot;assets/img/yomnan/1.jpg&quot;) top / contain;"></div>
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="process-register.php" method="POST" class="user">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6"><input class="form-control form-control-user" type="password"
                                            ...
                                            name="password_account2" required></div>
                            ...
                            <div class="text-center"><a class="small" href="form-login.php">Already have an account?
                                    Login!</a></div>
                        </div>
                    </div>
                </div>
